...
public class PatternController {
    ...
    private static final List<List<Boolean>> patternList = new ArrayList<>
            (Arrays.asList(
                    ...
                    Arrays.asList(true, false, false, true, false, false),
                    ...
                    //i
                    Arrays.asList(false, true, true, false, false, false),
                    Arrays.asList(false, true, true, true, false, false),
                    Arrays.asList(true, false, false, false, true, false),
                    Arrays.asList(true, false, true, false, true, false),
                    ...
                    Arrays.asList(false, true, true, false, true, false),
                    Arrays.asList(false, true, true, true, true, false),
                    Arrays.asList(true, false, false, false, true, true),
                    Arrays.asList(true, false, true, false, true, true),
                    Arrays.asList(false, true, true, true, false, true),
